...
class JoyBridge():
    def __init__(self):
        ...
        rospy.Subscriber('/joy', Joy, self._joy_changed)
    ...
    def _joy_changed(self, data):
        self.x = -data.axes[0]*50.0
        self.y = data.axes[1]*50.0
        self.z = data.axes[3]*50.0 + 130.0 + self.z_offset
